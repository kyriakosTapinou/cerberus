...
def plot(frame, data, output_name):
    ...
    ni = data["nd-ions"]["value"]
    ni_min = frame["nd-ions"]["min"]
    ni_max = frame["nd-ions"]["max"]

    ne = data["nd-electrons"]["value"]
    ne_min = frame["nd-electrons"]["min"]
    ne_max = frame["nd-electrons"]["max"]
